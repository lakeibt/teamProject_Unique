...
<!-- NProgress -->
<link
	href="${resources}vendors/nprogress/nprogress.css"
	rel="stylesheet">
<!-- iCheck -->
<link
	href="${resources}vendors/iCheck/skins/flat/green.css"
	rel="stylesheet">
...
<!-- Custom Theme Style -->
<link href="${resources}build/css/custom.min.css"
	rel="stylesheet">
</head>
