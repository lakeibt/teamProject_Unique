...
<div class="icon-box">
	<div class="icon-box">
		<form class="php-email-form" name="askPro" action="${admin }facility/ask_pro" style="background-color:white;">
			...
			<table class="table" style="font-size:12px;">
				...
				<tbody>
					<tr>
						...
						<th style="width:10%;"><input name="type" class="form-control" value="${content.TYPE }" readOnly></th>
						<th style="width:5%;">기자재코드</th>
						<th style="width:10%;"><input name="code" class="form-control" value="${content.CODE }" readOnly></th>
						<th style="width:5%;">분류코드</th>
						<th style="width:10%;"><input name="kind" class="form-control" value="${content.KIND }" readOnly></th>
