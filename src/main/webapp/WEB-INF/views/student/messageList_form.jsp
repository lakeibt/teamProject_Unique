...
function message_send2(){ message_send(); }
</script>
					...
					<c:forEach var="dto" items="${dtos}">
						<tr>
							...
							<td class="messageTitle" id="${dto.getNum()}">
								<a href="#" onclick="message_load(${dto.getNum()})" style="color: black;">${dto.getTitle()}</a>
							</td>
							<td>${dto.getSender()}</td>
			...
			<tfoot>
				<tr>
					<td colspan="8" align="center">
						<button type="button" class="btn btn-info" id="message_sendform_btn" onclick="message_send2()">쪽지쓰기</button>
					</td>
				</tr>
			</tfoot>
		</table>
